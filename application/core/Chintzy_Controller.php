...
class Chintzy_Controller extends CI_Controller {
    ...
    protected $footer = array("scripts" => array());
    ...
    public function view_plain_header() {
        $this->load->view("main/plain_header", $this->header);
    }

    public function view_plain_footer() {
        $this->load->view("main/plain_footer", $this->footer);
    }
}
